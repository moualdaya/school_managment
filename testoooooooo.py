...
class App:
    ...
    def setup_ui(self):
        ...
        # Adding entries
        self.add_entry(524.0, 454.0, 135.0, 14.0, "entry_1.png", 591.5, 462.0)
        self.add_entry(524.0, 426.0, 135.0, 14.0, "entry_2.png", 591.5, 434.0)
        self.add_entry(524.0, 398.0, 135.0, 13.0, "entry_3.png", 591.5, 405.5)
        self.add_entry(524.0, 369.0, 135.0, 14.0, "entry_4.png", 591.5, 377.0)
        self.add_entry(524.0, 341.0, 135.0, 14.0, "entry_5.png", 591.5, 349.0)

        self.add_entry(141.0, 454.0, 135.0, 14.0, "entry_6.png", 208.5, 462.0)
        self.add_entry(141.0, 426.0, 135.0, 14.0, "entry_7.png", 208.5, 434.0)
        self.add_entry(141.0, 398.0, 135.0, 13.0, "entry_8.png", 208.5, 405.5)
        self.add_entry(141.0, 369.0, 135.0, 14.0, "entry_9.png", 208.5, 377.0)
        self.add_entry(141.0, 341.0, 135.0, 14.0, "entry_10.png", 208.5, 349.0)

        self.add_entry(111.0, 141.0, 676.0, 22.0, "entry_11.png", 449.0, 153.0)
